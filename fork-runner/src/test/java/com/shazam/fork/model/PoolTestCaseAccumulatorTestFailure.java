...
public class PoolTestCaseAccumulatorTestFailure {
    ...
    private final TestCaseEvent A_TEST_CASE = newTestCase("a_method", "a_class", annotations, false);
    private final TestCaseEvent ANOTHER_TEST_CASE = newTestCase("another_method", "a_class", annotations, false);
